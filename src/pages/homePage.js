                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item d-flex">
                            <div class="input-group mb-4 mt-3 border-bottom">
                                <input type="search" placeholder="Search" aria-describedby="button-addon3" class="form-control bg-none border-0 fs-6" />
                        ...
                        <li class="nav-item cta cta-colored"><a href="#" class="nav-link">
                            ...
                            [0]</a></li>
                        <li class="nav-item"><a href="#" class="nav-link"><i class="fa fa-user" aria-hidden="true"></i></a></li>
                    </ul>
                </div>
            </div>
        </nav>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-3 ftco-animate">
                        <div class="product">
                            ...
                            <div class="text py-3 pb-4 px-3 text-center">
                                <h3><a href="#" class=" text-decoration-none">Green Beans</a></h3>
                                <div class="d-flex">
                                    <div class="pricing">
                                        <p class="price"><span>$120.00</span></p>
                                    </div>
                    ...
                    <div class="col-md-6 col-lg-3 ftco-animate">
                        <div class="product">
                            ...
                            <div class="text py-3 pb-4 px-3 text-center">
                                <h3><a href="#" class=" text-decoration-none">Purple Cabbage</a></h3>
                                <div class="d-flex">
                                    <div class="pricing">
                                        <p class="price"><span>$120.00</span></p>
                                    </div>
                    ...
                    <div class="col-md-6 col-lg-3 ftco-animate">
                        <div class="product">
                            ...
                            <div class="text py-3 pb-4 px-3 text-center">
                                <h3><a href="#" class=" text-decoration-none">Tomatoe</a></h3>
                                <div class="d-flex">
                                    <div class="pricing">
                                        <p class="price"><span class="mr-2 price-dc">$120.00</span><span
                                                class="price-sale">$80.00</span></p>
                    ...
                    <div class="col-md-6 col-lg-3 ftco-animate">
                        <div class="product">
                            ...
                            <div class="text py-3 pb-4 px-3 text-center">
                                <h3><a href="#" class=" text-decoration-none">Brocolli</a></h3>
                                <div class="d-flex">
                                    <div class="pricing">
                                        <p class="price"><span>$120.00</span></p>
                                    </div>
                    ...
                    <div class="col-md-6 col-lg-3 ftco-animate">
                        <div class="product">
                            ...
                            <div class="text py-3 pb-4 px-3 text-center">
                                <h3><a href="#" class=" text-decoration-none">Carrots</a></h3>
                                <div class="d-flex">
                                    <div class="pricing">
                                        <p class="price"><span>$120.00</span></p>
                                    </div>
                    ...
                    <div class="col-md-6 col-lg-3 ftco-animate">
                        <div class="product">
                            ...
                            <div class="text py-3 pb-4 px-3 text-center">
                                <h3><a href="#" class=" text-decoration-none">Fruit Juice</a></h3>
                                <div class="d-flex">
                                    <div class="pricing">
                                        <p class="price"><span>$120.00</span></p>
                                    </div>
                        ...
                        <div class="ftco-footer-widget mb-4">
                            ...
                            <div class="d-flex">
                                <ul class="list-unstyled mr-l-5 pr-l-3 mr-4">
                                    ...
                                    <li><a href="#" class="py-2 d-block text-decoration-none">Returns &amp; Exchange</a></li>
                                    <li><a href="#" class="py-2 d-block text-decoration-none">Terms &amp; Conditions</a></li>
                    ...
                    <div class="col-md">
                        <div class="ftco-footer-widget mb-4">
                            ...
                            <div class="block-23 mb-3">
                                <ul>
                                    <li><span><i class="fa fa-map-marker" aria-hidden="true"></i></span><span class="text">203 Fake St. Mountain
                                            View, San Francisco, California, USA</span></li>
                                    <li><a href="#" class="text-decoration-none"><span><i class="fa fa-phone" aria-hidden="true"></i></span><span class="text">+2 392 3929
                                                210</span></a></li>
                                    <li><a href="#" class="text-decoration-none"><span><i class="fa fa-envelope" aria-hidden="true"></i></span><span
                    ...
                    <div class="col-md-12 text-center">
                        ...
                        <p>
                            ...
                            is made with <i class="icon-heart color-danger" aria-hidden="true"></i> by <a
                                href="#" class="text-decoration-none" target="_blank" style="color: #82ae46;">Colorlib</a>
