        ...
        <div class="container">
                ...
                <div class="col-md-12 ftco-animate">
                    <div class="cart-list">
                        <table class="table">
                            ...
                            <tbody>
                                <tr class="text-center">
                                    <td class="product-remove"><a href="#"><CloseIcon/></a></td>

                                    <td class="image-prod">
                                        <div class="col-2 mx-auto" style={{width: "50%", height:"50%"}}><img
                                                src={Product1} style={{height: "50%",width:"100%"}} /></div>
                                    </td>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td class="image-prod">
                                        <div class="col-2 mx-auto" style={{width: "50%",height:"50%"}}><img
                                                src={Product2} style={{height: "50%",width:"100%"}} /></div>
                                    </td>
            ...
            <div class="row justify-content-end">
                <div class="col-lg-4 mt-5 cart-wrap ftco-animate">
                    ...
                    <p><a href="checkout.html" class="btn btn-success py-3 px-4">Apply Coupon</a></p>
                </div>
                <div class="col-lg-4 mt-5 cart-wrap ftco-animate">
                    <div class="cart-total mb-3">
